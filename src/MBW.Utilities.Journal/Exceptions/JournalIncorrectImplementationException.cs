...
public sealed class JournalIncorrectImplementationException : Exception
{
    internal JournalIncorrectImplementationException(byte journalImplementationId, byte programImplementationId) : base(
        GetMessage(journalImplementationId, programImplementationId))
    {
    }
